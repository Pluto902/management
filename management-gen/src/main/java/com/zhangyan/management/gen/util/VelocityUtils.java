...
public class VelocityUtils {
    ...
    public static void setMenuVelocityContext(VelocityContext context, SysGenTable genTable)
    {
    ...
    public static void setSubVelocityContext(VelocityContext context, SysGenTable genTable)
    {
...
//        }
     ...
     * @return 返回需要导入的包列表
     */
    public static HashSet<String> getImportList(SysGenTable genTable)
    {
        List<SysGenTableColumn> columns = genTable.getColumns();
     ...
     * @return 返回字典组
     */
    public static String getDicts(SysGenTable genTable)
    {
        List<SysGenTableColumn> columns = genTable.getColumns();
        ...
        {
            List<SysGenTableColumn> subColumns = genTable.getSubTable().getColumns();
     ...
     * @param columns 列集合
     */
    public static void addDicts(Set<String> dicts, List<SysGenTableColumn> columns)
    {
        for (SysGenTableColumn column : columns)
        {
